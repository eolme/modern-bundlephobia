...
import { createProviderGA, createProviderYM, launchParams } from "@mntm/stats";
...
export const ClientAnalytics: FC<ClientAnalyticsProps> = ({ children }) => {
	...
	const yandex = useCreation(() =>
		createProviderYM(91289383, { trackLinks: true }),
	);

	return (
		<GoogleContext.Provider value={google}>
			<YandexContext.Provider value={yandex}>{children}</YandexContext.Provider>
