...
export const og = (...parts: string[]) =>
	`${process.env.NEXT_PUBLIC_HOST}/api/og/${merge(...parts)}`;

export const badge = (...parts: string[]) =>
	`${process.env.NEXT_PUBLIC_HOST}/api/badge/${merge(...parts)}`;
