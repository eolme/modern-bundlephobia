...
import { formatBytes, SizeName, SizeType } from "#/utils/size";
...
export const og = async (
	...
	const [{ default: NotoSansRegular }, { default: NotoSansSemiBold }] =
		await Promise.all([fontRegular(), fontSemibold()]);
